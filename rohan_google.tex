...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \textit{\scriptsize Courses: }{\scriptsize Machine Learning, Distributed Systems, Database Management, NoSQL, Statistics, \textbf{Java}  }
    \resumeSubheading
...
\section{Skills Summary}
	\resumeSubHeadingListStart
	\resumeSubItem{Languages} {\textbf{\textit{Proficient : Java}}, {\textit{Comfortable} : Python, C++, SQL, C, VB, C\#}}
	\resumeSubItem{Tools}{Django, GIT, JIRA, Matlab, Tableau, MS-Excel }
	\resumeSubItem{Databases}{ MS-SQL, Redis, MongoDB, Oracle 11g}
\resumeSubHeadingListEnd
...
{Designed a \textbf{Java} based application which would let users run data analysis on generic log files for emacs.}
\resumeSubItem{Rental Car Management System}
{Brainstomed and created a conceptual \textbf{ER Model} for Rental car companies.}
\resumeSubItem{Movie Review Classifier}
{Implemented a Naive Bayes classifier from scratch to classify IMDB movie reviews.}
\resumeSubItem{Hangman}
{Created a \textbf{Java Application} to play Hangman with real players or against the computer.}
\resumeSubHeadingListEnd
